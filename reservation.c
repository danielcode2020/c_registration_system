...
char *strremove(char *str, const char *sub)  // function to remove a subtstring from string
{
...
char * remove_spaces(char *str) // function to remove spaces from string
{
...
int stringCompare(char mj1[], char mj2[])  // function to compare two strings
{
    int i = 0, flag = 0;
...
cursor(bool showFlag) // function to show or hide the cursor in console
{
    ...
    cursorInfo.bVisible = showFlag; // set the cursor visibility 1 Show 0 No
...
int my_atoi(char *str) // function to convert string to int
{
  int result;
  int puiss;
...
void init() // this function deletes all dates from past before current date
{
...
void loading() // Simple loading console animation
{
    cursor(false);
    system("cls");
    printf("Loading .");
...
void view_base() // function to view all the dates registered
{
    system("cls");
    FILE *f;
    char s[1000],m[10];
...
void check(char c[1000]) // check in file for a specific date
{
    FILE *f;
    char s[1000];
    int ch=0;
...
void check_today() // check todays free hours
{
    system("cls");
    printf("Free hours : \n");
    check_hour("8");
...
void check_10days() // check next 10 days for free hours
{
    system("cls");
    printf("Free hours : \n");
...
int check_hour(char n[]) // check a specific hour
{
    FILE *f;
    char s[1000];
